...
FQ1=$FASTQ_DIR/'read1.fastq'
FQ2=$FASTQ_DIR/'read2.fastq'
...
echo $STAR --genomeDir $STAR_REF --readFilesIn $FQ_DIR/'read1.fastq' $FQ_DIR/'read2.fastq' --runThreadN 12 --outSAMunmapped Within --outFilterType BySJout --outSAMattributes NH HI AS NM MD --outSAMtype BAM SortedByCoordinate --quantMode TranscriptomeSAM --chimSegmentMin 20 --chimJunctionOverhangMin 20
$STAR --genomeDir $STAR_REF --readFilesIn $FQ_DIR/'read1.fastq' $FQ_DIR/'read2.fastq' --runThreadN 12 --outSAMunmapped Within --outFilterType BySJout --outSAMattributes NH HI AS NM MD --outSAMtype BAM SortedByCoordinate --quantMode TranscriptomeSAM --chimSegmentMin 20 --chimJunctionOverhangMin 20
